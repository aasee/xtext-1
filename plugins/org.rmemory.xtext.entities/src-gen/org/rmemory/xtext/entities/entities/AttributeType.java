...
public interface AttributeType extends EObject
{
   ...
   * @see org.rmemory.xtext.entities.entities.EntitiesPackage#getAttributeType_ElementType()
  ...
  /**
   * Sets the value of the '{@link org.rmemory.xtext.entities.entities.AttributeType#getElementType <em>Element Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.rmemory.xtext.entities.entities.EntitiesPackage#getAttributeType_Array()
   * @model
   * @generated
   */
  boolean isArray();
  ...
  /**
   * Sets the value of the '{@link org.rmemory.xtext.entities.entities.AttributeType#isArray <em>Array</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setLength(int)
   * @see org.rmemory.xtext.entities.entities.EntitiesPackage#getAttributeType_Length()
   * @model
   * @generated
   */
  int getLength();
  ...
  /**
   * Sets the value of the '{@link org.rmemory.xtext.entities.entities.AttributeType#getLength <em>Length</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
