...
public class PoValidator extends EObjectValidator {
	...
	/**
	 * Validates the quantity constraint of '<em>Item</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateItem_quantity(Item item, DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO implement the constraint
		// -> specify the condition that violates the constraint
		// -> verify the diagnostic details, including severity, code, and message
		// Ensure that you remove @generated or mark it @generated NOT
				...
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 0,
						 "_UI_GenericConstraint_diagnostic",
						 new Object[] { "quantity", getObjectLabel(item, context) },
						 new Object[] { item },
						 context));
			}
			return false;
	...
	/**
	 * Validates the Goober constraint of '<em>Item</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateItem_Goober(Item item, DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO implement the constraint
		// -> specify the condition that violates the constraint
		// -> verify the diagnostic details, including severity, code, and message
		// Ensure that you remove @generated or mark it @generated NOT
				...
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 0,
						 "_UI_GenericConstraint_diagnostic",
						 new Object[] { "Goober", getObjectLabel(item, context) },
						 new Object[] { item },
						 context));
			}
			return false;
	...
	/**
	 * Validates the comment constraint of '<em>Item</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public boolean validateItem_comment(Item item, DiagnosticChain diagnostics, Map<Object, Object> context) {
		// TODO implement the constraint
		// -> specify the condition that violates the constraint
		// -> verify the diagnostic details, including severity, code, and message
		// Ensure that you remove @generated or mark it @generated NOT
				...
				diagnostics.add
					(createDiagnostic
						(Diagnostic.ERROR,
						 ...
						 0,
						 "_UI_GenericConstraint_diagnostic",
						 new Object[] { "comment", getObjectLabel(item, context) },
						 new Object[] { item },
						 context));
			}
			return false;
